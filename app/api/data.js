...
export const data = 
    [
...

      {
        ...
        historia: ["Kutral nace el año 2019 con el objetivo de que cada joya fabricada sea una obra de arte única, creada con amor y dedicación por manos expertas. Nuestro objetivo es que te sientas identificado con tu grabado y que te ayude a contar tu historia.", "Por eso, apoyamos a artesanos Chilenos y trabajamos en estrecha colaboración con ellos para crear piezas auténticas. Únete a nuestra comunidad."],
